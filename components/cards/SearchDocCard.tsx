...
function SearchDocCard({
  ...
  return (
    <Link href={pathe}>
    <article
      className="flex w-full flex-col rounded-xl bg-slate-900/90 p-5 border border-black my-2 hover:border-primary-500 transition duration-800"
    >
