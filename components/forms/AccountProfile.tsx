  ...
  return (
    <div className="flex flex-col items-center w-1/2 ">
      <select 
        ...
        className="font-sans mb-4 block px-4 py-2 text-base border rounded-md shadow-sm bg-dark-2 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 "
      >
      ...
      <Button 
        onClick={onSubmit} 
        type='submit' 
        className={`w-1/2 ml-auto rounded-md shadow ${isButtonDisabled ? 'text-black bg-primary-200' : 'bg-primary-500 hover:opacitiy-90'} focus:outline-none focus:ring-2 focus:ring-primary-500 focus:ring-offset-2`}
